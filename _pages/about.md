...
I am a [Postdoctoral researcher](https://www.biology.ox.ac.uk/people/georgios-voulgaris) in Deep Learning and Computer Vision at the University of Oxford, working with [Prof Ben Sheldon](https://www.biology.ox.ac.uk/people/professor-ben-sheldon). My research is centred around developing novel deep learning models that advance feature representation learning in networks, with a particular focus on salient feature extraction for segmentation in complex, densely populated scenes. Additionally, I design new architectures for multimodal deep learning and data fusion, integrating diverse data sources—such as RGB, hyperspectral, thermal, and LiDAR data—to enhance generalisation across various domains. My work bridges theoretical advancements in deep learning with innovative applications in remote sensing, environmental monitoring, and industrial scene analysis.
...
Currently, I am developing an innovative architecture integrating a novel convolutional layer to enhance feature extraction and spatial context modelling on dense, complex aerial scenes. Moreover, I propose a novel hybrid CNN - Transformer model to further refine performance, demonstrating significant improvements over existing pure Transformer methods.

Additionally, I am working on a mid-level data fusion model for detecting cement plants in China. By integrating multi-temporal and multi-spectral satellite data, the model leverages deep learning to enhance industrial monitoring and provide more accurate detection in challenging environments. This research contributes to the [SDG 9: Industry, Innovation and Infrastructure](https://sdgs.un.org/goals/goal9).

I developed a novel architecture that enhances semantic segmentation in aerial images by extracting salient features and capturing more context through a wider receptive field. This approach improves the detection of water bodies (lakes, rivers) from UAVs, outperforming current methods by being more resilient to shadows and effectively retrieving information hidden beneath the canopy. This project contributes to the [SDG 6: Clean Water and Sanitation](https://sdgs.un.org/goals/goal6).
