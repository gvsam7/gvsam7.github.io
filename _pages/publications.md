...
* [2025] 1 more paper (first author) under blind peer-review.
...
* Georgios Voulgaris, Maral Bayaraa, Cristian Rossi. (2025). Detecting Cement Plants with Landsat-8: A Physics-Informed, Multi-Temporal, and Multi-Spectral Deep Learning Fusion Approach (Under Review).    
